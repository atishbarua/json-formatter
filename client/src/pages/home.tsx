...
export default function Home() {
  ...
  return (
    <>
      <Helmet>
        <title>JSON Formatter, Validator & Viewer | Free Online</title>
        <meta name="description" content="Free JSON formatter..." />
        <link rel="canonical" href="https://jsonview.help/" />
      </Helmet>
        ...
        <footer className="border-t border-border py-4 px-4">
          <div className="max-w-7xl mx-auto flex items-center justify-between text-sm text-muted-foreground">
            ...
            <div className="flex items-center gap-4">
              {/* THIS IS THE KEY SEO FIX: An internal link to a relevant page */}
